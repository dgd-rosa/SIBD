...
print('<html>')
print('<head>')
print('<title>Incident Edit</title>')
...
try:
    ...
    print('<h1> Incident\'s Description change for')
    print(instant)
    print(' and ')
    print(id)
    print('</h1>')
    ...
    print('<form action="update_description_database.cgi" method="post">')
    ...
    print(id)
    print('"/></p>')
    print('<p>description:<input class="form-control" type="text" name="description" placeholder="Current description: ')
    print(description)
    print('"/></p>')
